...
function ModelByCompany() {
    ...
    const filteredModels = modelData.filter(model => {
        ...
        return subcategoryFilterPassed && priceRangeFilterPassed && reviewsFilterPassed && starsFilterPassed;
    });
        ...
        <div className='bg-sky-100 min-h-screen'>
            ...
            <div className="p-5 py-20 relative">
                ...
                <div className="flex flex-col sm:flex-row lg:flex-row gap-5">
                    ...
                    <div className={`flex flex-wrap sm:w-auto lg:w-full lg:h-[100%] sm:h-full z-${isSidebarOpen ? '0' : '20'}`}>
                      
                    { !loading ? <>
                        {sortedModels.map((model) => (
                            <div key={model._id} className='w-full sm:w-[70%] vsm:sm:w-[60%] lg:w-[20%] px-2 my-2'>
                    ...
                    <div className="lg:w-full sm:w-full lg:ml-0 sm:ml-24 h-96 px-2 my-2 flex text-center justify-center text-2xl font-semibold text-gray-600 items-center">Loading...</div>
                    </>
