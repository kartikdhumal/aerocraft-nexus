  ...
  return (
    <div className='bg-sky-100'>
      ...
      <div className='p-5'>
        ...
        <div className="flex flex-row flex-wrap gap-5 p-5 justify-center items-center">
          {filteredCategories
            ...
            .map((category) => (
              <div key={category.id} className='w-full sm:w-40 lg:w-60'>
      ...
      <div className='p-5'>
        ...
        <div className="flex flex-row flex-wrap gap-5 p-5 justify-center items-center">
          {shuffledCompanyData.filter(company => modelData.some(model => model.companyId === company.id)).slice(0,10).map(company => (
              <div key={company.id} className='w-full sm:w-40 lg:w-60'>
      ...
      <div className='p-5 '>
        ...
        <div className="flex flex-row flex-wrap gap-5 p-5 justify-center items-center">
          {shuffledModelData.slice(0, 10).map((model) => (
            <div key={model._id} className='w-full sm:w-40 lg:w-60'>
