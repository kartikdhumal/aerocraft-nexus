...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{D5C6E0D5-1D4A-9ADD-669E-489B70FB95BC}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\bcrypt_lib.node">
      ...
      <Command>call mkdir &quot;D:\prime2024\server\node_modules\bcrypt\lib\binding\napi-v3&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)bcrypt_lib.node&quot; &quot;D:\prime2024\server\node_modules\bcrypt\lib\binding\napi-v3\bcrypt_lib.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/bcrypt_lib.node to D:\prime2024\server\node_modules\bcrypt\lib\binding\napi-v3</Message>
      <Outputs>D:\prime2024\server\node_modules\bcrypt\lib\binding\napi-v3\bcrypt_lib.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="bcrypt_lib.vcxproj">
      <Project>{114DAC44-F3D8-BBA5-7272-5690F00C2D7F}</Project>
